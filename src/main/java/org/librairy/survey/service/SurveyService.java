...
public class SurveyService {
    ...
    public boolean deleteQuestions(){
        return questionsDao.deleteAll();
    }


    public AnswerList getAnswers(Integer size, String page){

        Integer maxNum = (size != null)? size : 100;
        Optional<String> offset = Strings.isNullOrEmpty(page)? Optional.empty() : Optional.of(page);

        return answerDao.listOf(maxNum, offset);
